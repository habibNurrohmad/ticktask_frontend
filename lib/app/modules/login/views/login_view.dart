...
class LoginView extends GetView<LoginController> {
  ...
  Widget build(BuildContext context) {
    ...
    // local observable to control password visibility when controller doesn't expose it
    final hide = true.obs;
    // local observable to track loading state if the controller doesn't expose it
                    ...
                    () => Row(
                      children: [
                        Checkbox(
                          ...
                          onChanged: (_) => controller.remember.toggle(),
              ...
              Obx(
                () => SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: isLoading.value ? null : controller.login,
